...
const Index = () => {
  ...
  const historyEvents = [
    { year: '1990', title: 'Основание ассоциации', description: 'Создание казачьей ассоциации «Держава» для возрождения традиций' },
  ...
  const members = [
    { name: 'Иван Петрович Соколов', role: 'Атаман', description: 'Руководит ассоциацией с 2010 года' },
      ...
      <footer className="border-t py-12 bg-accent text-accent-foreground">
        <div className="container">
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              ...
              <p className="text-accent-foreground/80">
                Казачья ассоциация по возрождению и сохранению традиций казачества
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-accent-foreground/20 text-center text-accent-foreground/60">
            <p>© 2024 Казачья ассоциация «Держава». Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
